...
export async function GET(
  ...
  try {
    ...
    const upstream = `${baseURL}/admin/api/devices/${encodeURIComponent(serial)}/overview`;
    ...
    return NextResponse.json({ error: 'Failed to fetch device overview', exception: e?.message }, { status: 500 });
  }
}
