...
export async function GET(req: NextRequest) {
  try {
    ...
    const res = await axios.get(`${baseURL}/admin/api/companies`, {
    ...
    return NextResponse.json({ error: 'Failed to fetch companies', exception: e?.message }, { status: 500 });
  }
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    const res = await axios.post(`${baseURL}/admin/api/companies`, body, {
    ...
    return NextResponse.json({ error: 'Failed to create company', exception: e?.message }, { status: 500 });
  }
}
